...
import ActivityIndicatorScreen from '../components/ActivityIndicator';
  ...
  export default function DriverForm() {
    ...
    const SignInHandler = async () => {
      if (!name || license || !contact || !address) {
      ...
      setSearching(true);
      try {
        const User = await login(name, license, countryCode+contactNumber);
        if (User) {
        ...
        <View contentContainerStyle={{flexGrow: 1}}>
          <View style={styles.Container}>
            ...
            <ScrollView style={styles.FormContainer}>
              <Text style={styles.SignInText}>Driver form</Text>
              <View>
                <Text style={styles.EmailText}>Driver Name</Text>
                <TextInput
              ...
              <View>
                <Text style={styles.EmailText}>Driver license no.</Text>
                <TextInput
                  placeholderTextColor="gray"
                  placeholder="deepak123@gmail.com"
                  style={[styles.InputEmail, {color: 'black'}]}
                  value={license}
                  onChangeText={setLicense}></TextInput>
              </View>
              <View>
